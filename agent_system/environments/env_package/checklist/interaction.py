...
class ChecklistInteraction:
    ...
    async def generate_response(
        ...
        per_step_results_list = [result[1] for result in results]
    ...
    async def generate_response_for_single_checklist(
        ...
        org_flat_per_step_results: list[tuple[bool, bool, bool]] = await asyncio.gather(*all_step_results_this_turn)
        ...
        per_step_results = [flat_per_step_results[i:i+len(this_turn_checklist)] for i in range(0, len(flat_per_step_results), len(this_turn_checklist))]
        per_step_call_success = [flat_per_step_call_success[i:i+len(this_turn_checklist)] for i in range(0, len(flat_per_step_call_success), len(this_turn_checklist))]
